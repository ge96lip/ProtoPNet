...
class XProtoNet_Base(ProtoPNet_Base):
    ...
    def get_optimizer(self):
        ...
        self.joint_optimizer = torch.optim.AdamW(joint_optimizer_specs)
        ...
        self.warm_optimizer = torch.optim.AdamW(warm_optimizer_specs)
        ...
        self.last_layer_optimizer = torch.optim.AdamW(last_layer_optimizer_specs)
    ...
    def run_epoch(self, epoch, optimizer=None, mode="train"):
        ...
        with torch.set_grad_enabled(mode == "train"):
            ...
            for i in iterator:
                ...
                input = data_sample[0].to(self.device)
                target = data_sample[1].to(self.device)
        ...
        logging.info(
            ...
            f"Balanced Acc: {accu:.2%} | f1: {[f'{f1[j]:.2%}' for j in range(f1.shape[0])]} | f1_avg: {f1_mean:.4f} | AUC: {AUC} | MCC: {mcc} | ACC: {acc} \n"
    ...
    def explain_global(self, mode="test"):
        """
