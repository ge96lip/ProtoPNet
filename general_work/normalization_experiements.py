...
def main():
    data_dir = "/path/to/medmnist"  # Folder containing medmnist library 
    output_file = "/path/to/ProtoPNet/general_work/mean_std_results.txt"  # Output file
