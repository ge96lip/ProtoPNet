...
def get_args_parser():
    ...
    choices=['CUB2011U', 'Car', 'Dogs', 'Med', 'ULT', 'PathMNIST', 'TissueMNIST', 'RetinaMNIST', 'BloodMNIST', 'DermaMNIST', 'PneumoniaMNIST', 'OrganCMNIST','OrganSMNIST', 'OrganAMNIST', 'OCTMNIST', 'BreastMNIST'],
