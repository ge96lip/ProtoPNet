...
if "%data_set%"=="CUB2011U" (
    ...
    set "global_proto_per_class=3"
    set "prototype_num=600"
    set "reserve_token_nums=81"
) else if "%data_set%"=="ULT" (
    set "global_proto_per_class=3"
    set "prototype_num=30"
    set "reserve_token_nums=81"
) else if "%data_set%"=="PathMNIST" (
    set "global_proto_per_class=3"
    set "prototype_num=45"
    set "reserve_token_nums=81"
) else if "%data_set%"=="ChestMNIST" (
    set "global_proto_per_class=3"
    set "prototype_num=10"
    set "reserve_token_nums=81"
) else if "%data_set%"=="DermaMNIST" (
    set "global_proto_per_class=3"
    set "prototype_num=70"
    set "reserve_token_nums=81"
) else if "%data_set%"=="OCTMNIST" (
    set "global_proto_per_class=3"
    set "prototype_num=20"
    set "reserve_token_nums=81"
) else if "%data_set%"=="PneumoniaMNIST" (
    set "global_proto_per_class=3"
    set "prototype_num=10"
    set "reserve_token_nums=81"
) else if "%data_set%"=="RetinaMNIST" (
    set "global_proto_per_class=3"
    set "prototype_num=25"
    set "reserve_token_nums=81"
) else if "%data_set%"=="BreastMNIST" (
    set "global_proto_per_class=3"
    set "prototype_num=16"
    set "reserve_token_nums=81"
) else if "%data_set%"=="BloodMNIST" (
    set "global_proto_per_class=3"
    set "prototype_num=40"
    set "reserve_token_nums=81"
) else if "%data_set%"=="TissueMNIST" (
    set "global_proto_per_class=3"
    set "prototype_num=40"
    set "reserve_token_nums=81"
) else if "%data_set%"=="OrganAMNIST" (
    set "global_proto_per_class=3"
    set "prototype_num=55"
    set "reserve_token_nums=81"
) else if "%data_set%"=="OrganSMNIST" (
    set "global_proto_per_class=3"
    set "prototype_num=55"
    set "reserve_token_nums=81"
) else if "%data_set%"=="OrganCMNIST" (
    set "global_proto_per_class=3"
    set "prototype_num=55"
    set "reserve_token_nums=81"
)
