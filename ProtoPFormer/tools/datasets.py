...
import numpy as np
import pandas as pd
from medmnist import BreastMNIST, PathMNIST, TissueMNIST, RetinaMNIST, BloodMNIST, DermaMNIST, PneumoniaMNIST, OCTMNIST, \
...
class MedMNISTWithIndex(Dataset):
    ...
    """
        ...
        if hasattr(self.medmnist_dataset, attr):
            return getattr(self.medmnist_dataset, attr)
        raise AttributeError(f"'{self.__class__.__name__}' object and wrapped dataset have no attribute '{attr}'")
...
def build_dataset_view(is_train, args):
    ...
    if 'adam' in args.model[0]:
        ...
        transform = transforms.Compose([
            transforms.Resize(size=large_size),  # transforms.Resize(size=large_size, interpolation=3),
    ...
    if args.data_set == 'CIFAR100':
        ...
        nb_classes = 120
    elif args.data_set == 'Med':
        dataset = Med(root=os.path.join(args.data_path, 'med'), train=is_train,
                      transform=transform)
        nb_classes = 3
    elif args.data_set == 'ULT':
        dataset = ULT(root=os.path.join(args.data_path, 'Dataset_BUSI_with_GT'), train=is_train,
                      transform=transform)
        nb_classes = 3
    elif args.data_set == "PathMNIST":
        dataset = PathMNIST(split="test", download=False, size=224, transform=transform)
        nb_classes = 9
    elif args.data_set == "DermaMNIST":
        dataset = DermaMNIST(split="test", download=True, size=224, transform=transform)
        dataset = MedMNISTWithIndex(dataset)
        nb_classes = 7
    elif args.data_set == "TissueMNIST":
        dataset = TissueMNIST(split="test", download=False, size=224, transform=transform)
        nb_classes = 8
    elif args.data_set == "RetinaMNIST":
        dataset = RetinaMNIST(split="test", download=True, size=224, transform=transform)
        nb_classes = 5
    elif args.data_set == "BloodMNIST":
        dataset = BloodMNIST(split="test", download=True, size=224, transform=transform)
        dataset = MedMNISTWithIndex(dataset)
        nb_classes = 8
    elif args.data_set == "PneumoniaMNIST":

        dataset = PneumoniaMNIST(split="test", download=True, size=224, transform=transform, as_rgb=True)
        dataset = MedMNISTWithIndex(dataset)
        nb_classes = 2
    elif args.data_set == "OCTMNIST":
        dataset = OCTMNIST(split="test", download=True, size=224, transform=transform, as_rgb=True)
        nb_classes = 4
    elif args.data_set == "OrganAMNIST":
        dataset = OrganAMNIST(split="test", download=True, size=224, transform=transform, as_rgb=True)
        nb_classes = 11
    elif args.data_set == "OrganSMNIST":
        dataset = OrganSMNIST(split="test", download=True, size=224, transform=transform, as_rgb=True)
        nb_classes = 11
    elif args.data_set == "OrganCMNIST":
        dataset = OrganCMNIST(split="test", download=True, size=224, transform=transform, as_rgb=True)
        nb_classes = 11
    elif args.data_set == "BreastMNIST":
        dataset = BreastMNIST(split="test", download=True, size=224, transform=transform, as_rgb=True)
        nb_classes = 2
...
def build_dataset_noaug(is_train, args):
    ...
    if args.data_set == 'CIFAR100':
        ...
        dataset = Med(root=os.path.join(args.data_path, 'med'), train=is_train, transform=transform)
        nb_classes = 3
    elif args.data_set == 'ULT':
        dataset = ULT(root=os.path.join(args.data_path, 'Dataset_BUSI_with_GT'), split='test', train=is_train,
                      transform=transform)
        nb_classes = 3
    elif args.data_set == "PathMNIST":
        #transform.append(transforms.Normalize(mean=[.5], std=[.5]))
        dataset = PathMNIST(split="test", download=False, size=224, transform=transform)
        nb_classes = 9
    elif args.data_set == "TissueMNIST":
        #transform.append(transforms.Normalize(mean=[.5], std=[.5]))
        ...
        #transform.append(transforms.Normalize(mean=[.71737], std=[.21447]))
        dataset = BloodMNIST(split="test", download=True, size=224, transform=transform)
        dataset = MedMNISTWithIndex(dataset)
        nb_classes = 8
    elif args.data_set == "DermaMNIST":
        #transform.append(transforms.Normalize(mean=[.62095], std=[.18783]))
        dataset = DermaMNIST(split="test", download=True, size=224, transform=transform)
        dataset = MedMNISTWithIndex(dataset)
        nb_classes = 7
    elif args.data_set == "PneumoniaMNIST":
        #transform.append(transforms.Normalize(mean=[.57166], std=[.17704]))
        dataset = PneumoniaMNIST(split="test", download=True, size=224, transform=transform, as_rgb=True)
        #dataset = MedMNISTWithIndex(dataset)
        nb_classes = 2
    elif args.data_set == "RetinaMNIST":
        #transform.append(transforms.Normalize(mean=[.26045], std=[.26057]))
        dataset = RetinaMNIST(split="test", download=True, size=224, transform=transform)
        nb_classes = 5
    elif args.data_set == "OCTMNIST":
        #transform.append(transforms.Normalize(mean=[.5], std=[.5]))
        ...
        #transform.append(transforms.Normalize(mean=[.46803], std=[.28758]))
        dataset = OrganAMNIST(split="test", download=True, size=224, transform=transform, as_rgb=True)
        nb_classes = 11
    elif args.data_set == "OrganSMNIST":
        #transform.append(transforms.Normalize(mean=[.49522], std=[.27690]))
        dataset = OrganSMNIST(split="test", download=True, size=224, transform=transform, as_rgb=True)
        nb_classes = 11
    elif args.data_set == "OrganCMNIST":
        #transform.append(transforms.Normalize(mean=[.49419], std=[.27756]))
        dataset = OrganCMNIST(split="test", download=True, size=224, transform=transform, as_rgb=True)
        nb_classes = 11
    elif args.data_set == "BreastMNIST":
        #transform.append(transforms.Normalize(mean=[.32769], std=[.21943]))
        dataset = BreastMNIST(split="test", download=True, size=224, transform=transform, as_rgb=True)
        nb_classes = 2
    elif args.data_set == 'CUB2011':
        if is_train:
...
def build_dataset(is_train, args):
    ...
    #mnist_transform = build_mnist_transform()
    if args.data_set == 'CIFAR100':
        ...
        dataset = Cub2011(args.data_path, train=is_train, transform=transform, download=True)
        nb_classes = 200
    elif args.data_set == 'Car':
        split = 'train' if is_train else 'test'
        dataset = StanfordCars(args.data_path, split=split, transform=transform, download=True)
    ...
    #     nb_classes = 196
        ...
        #mnist_transform.append(transforms.Normalize(mean=[.32769], std=[.21943]))
        #mnist_transform = transforms.Compose(mnist_transform)

        if is_train:
            dataset = PathMNIST(split="train", download=False, size=224, transform=transform)
        else:
            dataset = PathMNIST(split="val", download=False, size=224, transform=transform)
        nb_classes = 9
    elif args.data_set == "TissueMNIST":
        #mnist_transform.append(transforms.Normalize(mean=[.32769], std=[.21943]))
        #mnist_transform = transforms.Compose(mnist_transform)
        ...
        if is_train:
            dataset = TissueMNIST(split="train", download=False, size=224, transform=transform)
        else:
            dataset = TissueMNIST(split="val", download=False, size=224, transform=transform)
        nb_classes = 8
    elif args.data_set == "RetinaMNIST":
        #mnist_transform.append(transforms.Normalize(mean=[.26045], std=[.26057]))
        #mnist_transform = transforms.Compose(mnist_transform)

        if is_train:
            dataset = RetinaMNIST(split="train", download=True, size=224, transform=transform)
        else:
            dataset = RetinaMNIST(split="val", download=False, size=224, transform=transform)
        nb_classes = 5
    elif args.data_set == "BloodMNIST":
        #mnist_transform.append(transforms.Normalize(mean=[.71737], std=[.21447]))
        #mnist_transform = transforms.Compose(mnist_transform)

        if is_train:
            dataset = BloodMNIST(split="train", download=True, size=224, transform=transform)
            dataset = MedMNISTWithIndex(dataset)
        else:
            dataset = BloodMNIST(split="val", download=True, size=224, transform=transform)
            dataset = MedMNISTWithIndex(dataset)
        nb_classes = 8
    elif args.data_set == "DermaMNIST":
        #mnist_transform.append(transforms.Normalize(mean=[.62095], std=[.18783]))
        #mnist_transform = transforms.Compose(mnist_transform)

        if is_train:
            dataset = DermaMNIST(split="train", download=True, size=224, transform=transform)
            dataset = MedMNISTWithIndex(dataset)
        else:
            dataset = DermaMNIST(split="val", download=True, size=224, transform=transform)
            dataset = MedMNISTWithIndex(dataset)
        nb_classes = 7
    elif args.data_set == "PneumoniaMNIST":
        #mnist_transform.append(transforms.Normalize(mean=[.57166], std=[.17704]))
        #mnist_transform = transforms.Compose(mnist_transform)

        if is_train:
            dataset = PneumoniaMNIST(split="train", download=True, size=224, transform=transform, as_rgb=True)
            dataset = MedMNISTWithIndex(dataset)
        else:
            dataset = PneumoniaMNIST(split="val", download=True, size=224, transform=transform, as_rgb=True)
            dataset = MedMNISTWithIndex(dataset)
        nb_classes = 2
    elif args.data_set == "OCTMNIST":
        #mnist_transform.append(transforms.Normalize(mean=[.5], std=[.5]))
        #mnist_transform = transforms.Compose(mnist_transform)

        if is_train:
            dataset = OCTMNIST(split="train", download=True, size=224, transform=transform, as_rgb=True)
        else:
            dataset = OCTMNIST(split="val", download=True, size=224, transform=transform, as_rgb=True)
        nb_classes = 4
    elif args.data_set == "OrganAMNIST":
        #mnist_transform.append(transforms.Normalize(mean=[.46803], std=[.28758]))
        #mnist_transform = transforms.Compose(mnist_transform)

        if is_train:
            dataset = OrganAMNIST(split="train", download=True, size=224, transform=transform, as_rgb=True)
        else:
            dataset = OrganAMNIST(split="val", download=True, size=224, transform=transform, as_rgb=True)
        nb_classes = 11
    elif args.data_set == "OrganSMNIST":
        #mnist_transform.append(transforms.Normalize(mean=[.49522], std=[.27690]))
        #mnist_transform = transforms.Compose(mnist_transform)

        if is_train:
            dataset = OrganSMNIST(split="train", download=True, size=224, transform=transform, as_rgb=True)
        else:
            dataset = OrganSMNIST(split="val", download=True, size=224, transform=transform, as_rgb=True)
        nb_classes = 11
    elif args.data_set == "OrganCMNIST":
        #mnist_transform.append(transforms.Normalize(mean=[.49419], std=[.27756]))
        #mnist_transform = transforms.Compose(mnist_transform)

        if is_train:
            dataset = OrganCMNIST(split="train", download=True, size=224, transform=transform, as_rgb=True)
        else:
            dataset = OrganCMNIST(split="val", download=True, size=224, transform=transform, as_rgb=True)
        nb_classes = 11
    elif args.data_set == "BreastMNIST":
       #mnist_transform.append(transforms.Normalize(mean=[.32769], std=[.21943]))
        #mnist_transform = transforms.Compose(mnist_transform)
        if is_train:
            dataset = BreastMNIST(split="train", download=True, size=224, transform=transform, as_rgb=True)
        else:
            dataset = BreastMNIST(split="val", download=True, size=224, transform=transform, as_rgb=True)
        nb_classes = 2
    elif args.data_set == 'CUB2011':
...
class ULT(Dataset):
    ...
    def split_data(self, samples):
        ...
        print("size is: ", len(train_samples), len(val_samples), len(test_samples))
    ...
    def load_samples(self):
        ...
        if self.train:
            ...
            # get val data:
            if self.split == 'test':
                print("returning test set")
                return self.split_data(samples)[2]
            else:
                print("returning val set")
