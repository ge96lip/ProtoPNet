...
def get_data(args: argparse.Namespace): 
    ...
    if args.dataset == 'mri_scans':
        return get_mri_scans(True, '/content/drive/MyDrive/Medmnist/blood_R/train','/content/drive/MyDrive/Medmnist/blood_R/train' ,'/content/drive/MyDrive/data_tugan_loader/test', args.image_size, args.seed, args.validation_size)
    ...
    if args.dataset == 'CARS':
        return get_mri_scans(True, '/content/drive/MyDrive/Medmnist/derma/train','/content/drive/MyDrive/Medmnist/breasts/train' ,'/content/drive/MyDrive/Medmnist/breasts/test', args.image_size, args.seed, args.validation_size)
...
def get_dataloaders2(args: argparse.Namespace, device):
    """
    Get data loaders
    """
...
def create_datasets(transform1, transform2, transform_no_augment, num_channels:int, train_dir:str, project_dir: str, test_dir:str, seed:int, validation_size:float, train_dir_pretrain = None, test_dir_projection = None, transform1p=None):
    ...
    if test_dir is None:
        ...
        train_indices, traest_indices = train_test_split(train_indices,test_size=validation_size,stratify=subset_targets, random_state=seed)
