...
def get_data(args: argparse.Namespace): 
    ...
    #ÄNDRA HÄR
    if args.dataset == 'breastmnist_224':
        return get_mri_scans(True,'Dataset/breastmnist_224/train', 'Dataset/breastmnist_224/train' , 'Dataset/breastmnist_224/val', args.image_size, args.seed, args.validation_size)
    ...
    if args.dataset == 'CARS':
        return get_mri_scans(True, '/content/drive/MyDrive/Medmnist/breasts/train','/content/drive/MyDrive/Medmnist/breasts/train' ,'/content/drive/MyDrive/Medmnist/breasts/val', args.image_size, args.seed, args.validation_size)
...
def get_pets(augment:bool, train_dir:str, project_dir: str, test_dir:str, img_size: int, seed:int, validation_size:float): 
    mean = (0.32769,0.32769,0.32769)
    std = (0.21943, 0.21943,0.21943)
    normalize = transforms.Normalize(mean=mean,std=std)
    transform_no_augment = transforms.Compose([
                            transforms.Resize(size=(img_size, img_size)),
                            transforms.ToTensor(),
